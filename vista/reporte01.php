...
<head>
    ...
    <title>SUNARP - Consulta de Devoluciones</title>
    ...
    <style>
        ...
        * {
        ...
        .loading-spinner {
            ...
            border-top: 4px solid var(--sunarp-orange);
            border-radius: 50%;
        ...
        .form-header {
            background: linear-gradient(135deg, var(--sunarp-orange) 0%, #ff7a33 100%);
            color: white;
            padding: 1.2rem 2rem;
            margin: 0;
        }
        ...
        .form-control:focus {
            border-color: var(--sunarp-orange);
        ...
        .btn-primary:hover {
            ...
            background: linear-gradient(135deg, #ff7a33 0%, var(--sunarp-orange) 100%);
        }
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="header-section">
            ...
            <h1 class="main-title">CONSULTA DE DEVOLUCIONES</h1>
            <p class="subtitle">Búsqueda por Documento de Identidad</p>
        </div>

        <!-- Form Section -->
        <div class="form-section">
            <div class="form-header">
                <h3><i class="fas fa-file-invoice-dollar"></i> Consulta por DNI</h3>
            </div>
            
            <div class="form-content">
                <form method="POST" action="../modelo/reporte_dni.php" id="consultaForm">
                    <div class="form-group">
                        <label for="SCHASIS"><i class="fas fa-id-card"></i> Número de DNI:</label>
                        <input type="text" class="form-control" name="SCHASIS" id="SCHASIS" 
                               placeholder="Ingrese el número de DNI" maxlength="8" required>
                        <small class="form-text text-muted">Ingrese el DNI de 8 dígitos</small>
                    </div>

                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-search me-2"></i>Consultar Devoluciones
                        </button>
                    </div>
                </form>
            </div>
    ...
    document.getElementById('SCHASIS').addEventListener('input', function(e) {
        ...
        // Cambiar color del borde si tiene contenido válido
        if (this.value.length === 8) {
            this.style.borderColor = 'var(--sunarp-green)';
    ...
    document.getElementById('consultaForm').addEventListener('submit', function(e) {
        const dni = document.getElementById('SCHASIS').value;
        if (dni.length !== 8) {
            e.preventDefault();
